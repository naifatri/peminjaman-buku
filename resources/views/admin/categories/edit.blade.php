...
<div class="mb-8">
    ...
    <p class="text-sm text-slate-500 mt-1">Perbarui informasi kategori buku Anda.</p>
</div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" 
                        class="w-full rounded-2xl border-slate-200 focus:border-indigo-500 focus:ring focus:ring-indigo-500/10 transition-all duration-300 px-4 py-3 text-slate-600 placeholder:text-slate-300">{{ old('description', $category->description) }}</textarea>
